...
$ficha_treino_result = $conn->query("SELECT * FROM ficha_de_treino WHERE id_usuario = $id_usuario ORDER BY id_ficha_treino DESC");
            ...
            <div class="input-container">
                ...
                <div class="input-item">
                    ...
                    <select name="prefTreino" id="prefTreino">
                        ...
                        <option value='Musculacao' <?php echo ($prefTreinoSelecionada == 'musculação') ? 'selected' : ''; ?>>Musculação</option>
