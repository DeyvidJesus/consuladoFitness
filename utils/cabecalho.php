...
<nav class="navegacao">
    ...
    <div class="nav_desktop">
        <ul>
            <li class="nav"><a href="../paginas/geraTreino.php" class="link">Treino</a></li>
            <li class="nav"><a href="../paginas/bibliotecaExercicios.php" class="link">Biblioteca</a></li>
            <li class="nav"><a href="../paginas/contato.php" class="link">Contato</a></li>
            <li class="nav"><a href="../paginas/perfil.php" class="link">Perfil</a></li>
